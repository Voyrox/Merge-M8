...
(async () => {
    ...
    const md = `
## Report for PR #${prNumber} — **${event.pull_request.title}** | Score: **${safety.score}%**
...
| Status | ${safety.score <= 50 ? "⚠️ Review recommended" : "✅ No major red flags"} |
...
- <span style="color: #1a7f37;">+${additions}</span> / <span style="color: #cf222e;">-${deletions}</span> lines  
